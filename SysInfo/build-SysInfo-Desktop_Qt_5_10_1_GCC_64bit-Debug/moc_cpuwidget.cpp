...
void CpuWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CpuWidget *_t = static_cast<CpuWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CpuWidget::staticMetaObject = {
    { &SysInfoWidget::staticMetaObject, qt_meta_stringdata_CpuWidget.data,
      qt_meta_data_CpuWidget,  qt_static_metacall, nullptr, nullptr}
};
