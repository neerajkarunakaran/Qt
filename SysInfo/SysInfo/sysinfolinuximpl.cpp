...
{
    _mCpuLoadLastValues = cpuRawData();
}

double SysInfoLinuxImpl::cpuLoadAvarage()
{
    QVector<qulonglong> firstSample = _mCpuLoadLastValues;
    QVector<qulonglong> secondSample = cpuRawData();
    _mCpuLoadLastValues = secondSample;
